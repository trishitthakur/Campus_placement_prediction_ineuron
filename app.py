'''App.py for the placement prediction Internship at INEURON.AI,
   Developed by TRISHIT NATH THAKUR'''
...
def predict():
    if request.method == "POST" :
        ...
        y_pred=y_pred[0]
        if y_pred == 0:
            return render_template('show.html',res="Work Hard!!! Chances are less, You need to improve") 
        else:
            return render_template('show.html',res=" You are Doing well!! You Will Get placements !!! Keep Working Hard")
